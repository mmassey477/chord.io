...
!function(){"use strict";function t(t,e,o,n,i,c,r){var u=this;u.user=o.user,u.close=function(){r.hide()},u.okay=function(){r.hide()}}angular.module("core").controller("partyController",t),t.$inject=["$scope","$state","Authentication","menuService","$http","$location","$mdDialog"]}();
...
!function(){"use strict";function e(e,t,n,o,u){function c(){s.isCollapsed=!1}var s=this;s.user=n.user,console.log("userr",s.user),s.accountMenu=o.getMenu("account").items[0],s.authentication=n,s.isCollapsed=!1,s.menu=o.getMenu("topbar"),e.$on("$stateChangeSuccess",c)}angular.module("core").controller("HeaderController",e),e.$inject=["$scope","$state","Authentication","menuService","$http"]}();
!function(){"use strict";function o(o,t,n,e,i,c,l){console.log("Auth",n),n.user?t.go("spotify"):t.go("signin")}angular.module("core").controller("HomeController",o),o.$inject=["$scope","$state","Authentication","$window","menuService","$http","$location"]}();
!function(){"use strict";function t(t,e,o,n,r,l,i){function c(){}function a(){i.show({templateUrl:"modules/party/client/views/newParty.dialog.client.view.html",parent:angular.element(document.body),clickOutsideToClose:!0,controller:"partyController",controllerAs:"vm"})}var u=this;u.user=o.user,u.joinParty=a,u.createParty=c,u.user||e.go("signin")}angular.module("core").controller("SpotifyController",t),t.$inject=["$scope","$state","Authentication","menuService","$http","$location","$mdDialog"]}();
!function(){"use strict";function o(o,t,e,n,c,i,r,s){i.post("/api/auth/spotify",r.$$search).success(function(o){n.user=o[0],t.go("home")}).error(function(o){console.log(o)})}angular.module("core").controller("SpotifyURIController",o),o.$inject=["$scope","$state","$window","Authentication","menuService","$http","$location","$mdDialog"]}();
