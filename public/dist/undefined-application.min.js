!function(e){"use strict";function n(e,n){angular.module(e,n||[]),angular.module(i).requires.push(e)}var i="mean",a={applicationEnvironment:e.env,applicationModuleName:i,applicationModuleVendorDependencies:["ngResource","ngAnimate","ngMaterial","ngMessages","ui.router","ui.bootstrap"],registerModule:n};e.ApplicationConfiguration=a}(window);
...
!function(){"use strict";function t(t,o,e,n,r,c){var i=this;i.user=e.user}angular.module("core").controller("DjController",t),t.$inject=["$scope","$state","Authentication","$http","$location","$mdDialog"]}();
!function(){"use strict";function t(t,o,e,n,r,a,c){var i=this;i.user=e.user,i.close=function(){c.hide()},i.okay=function(){c.hide(),console.log("vm.partyName",i.partyName),r.post("/api/party/newParty",{name:i.partyName}).success(function(t){n.connect()}).error(function(t){throw t}),o.go("party")}}angular.module("core").controller("partyController",t),t.$inject=["$scope","$state","Authentication","Socket","$http","$location","$mdDialog"]}();
!function(){"use strict";function t(t,e,l,o){function r(){o.show({templateUrl:"modules/party/client/views/createParty.dialog.client.view.html",parent:angular.element(document.body),clickOutsideToClose:!0,controller:"partyController",controllerAs:"vm"})}function n(){o.show({templateUrl:"modules/party/client/views/newParty.dialog.client.view.html",parent:angular.element(document.body),clickOutsideToClose:!0,controller:"partyController",controllerAs:"vm"})}var a={};return a.joinParty=n,a.createParty=r,a}angular.module("core").factory("PartyService",t),t.$inject=["Authentication","$state","$timeout","$mdDialog"]}();
...
!function(){"use strict";function t(t,e){e.rule(function(t,e){var r=e.path(),l=r.length>1&&"/"===r[r.length-1];if(l){var o=r.substr(0,r.length-1);e.replace().path(o)}}),e.otherwise(function(t,e){t.get("$state").transitionTo("not-found",null,{location:!1})}),t.state("home",{url:"/",controller:"HomeController",controllerAs:"vm"}).state("party",{url:"/party",templateUrl:"modules/party/client/views/listQueue.client.view.html",controller:"DjController",controllerAs:"vm"}).state("signin",{url:"/signin",templateUrl:"modules/users/client/views/signin.client.view.html",controller:"AuthenticationController"}).state("spotify",{url:"/spotify",templateUrl:"/modules/party/client/views/create-join-party.client.view.html",controller:"SpotifyController",controllerAs:"vm"}).state("spotifyURI",{url:"/spotifyURI",controller:"SpotifyURIController",controllerAs:"vm"}).state("not-found",{url:"/not-found",templateUrl:"/modules/core/client/views/404.client.view.html",controller:"ErrorController",controllerAs:"vm",params:{message:["$stateParams",function(t){return t.message}]},data:{ignoreState:!0}}).state("bad-request",{url:"/bad-request",templateUrl:"/modules/core/client/views/400.client.view.html",controller:"ErrorController",controllerAs:"vm",params:{message:["$stateParams",function(t){return t.message}]},data:{ignoreState:!0}}).state("forbidden",{url:"/forbidden",templateUrl:"/modules/core/client/views/403.client.view.html",data:{ignoreState:!0}})}function e(t){var e=t.user;return console.log("Userrr",e),e.$promise}angular.module("core.routes").config(t),t.$inject=["$stateProvider","$urlRouterProvider"],e.$inject=["Authentication"]}();
...
!function(){"use strict";function e(e,t,r,a,n){function o(){s.isCollapsed=!1,s.user=r.user}var s=this;s.user=r.user,s.isCollapsed=!1,s.joinParty=a.joinParty,s.createParty=a.createParty,e.$on("$stateChangeSuccess",o)}angular.module("core").controller("HeaderController",e),e.$inject=["$scope","$state","Authentication","PartyService","$http"]}();
!function(){"use strict";function o(o,t,n,e,i,c){console.log("Auth",n),n.user?t.go("spotify"):t.go("signin")}angular.module("core").controller("HomeController",o),o.$inject=["$scope","$state","Authentication","$window","$http","$location"]}();
!function(){"use strict";function t(t,r,e,o,i,n,a){var c=this;c.user=e.user,c.joinParty=o.joinParty,c.createParty=o.createParty,c.user||r.go("signin")}angular.module("core").controller("SpotifyController",t),t.$inject=["$scope","$state","Authentication","PartyService","$http","$location","$mdDialog"]}();
!function(){"use strict";function t(t,o,n,i,c,e,a){var r=this;r.authentication=i,c.post("/api/auth/spotify",e.$$search).success(function(t){r.authentication.user=t[0],o.go("home")}).error(function(t){console.log(t)})}angular.module("core").controller("SpotifyURIController",t),t.$inject=["$scope","$state","$window","Authentication","$http","$location","$mdDialog"]}();
...
!function(){"use strict";function t(t){t.state("settings",{"abstract":!0,url:"/settings",templateUrl:"/modules/users/client/views/settings/settings.client.view.html",controller:"SettingsController",controllerAs:"vm",data:{roles:["user","admin"]}})}angular.module("users.routes").config(t),t.$inject=["$stateProvider"]}();
!function(){"use strict";function t(t,n,o,i,c,e){function u(){n.post("/api/auth/signin").success(function(t){window.location.href=t}).error(function(t){throw t})}var r=this;r.authentication=e,r.login=u}angular.module("users").controller("AuthenticationController",t),t.$inject=["$scope","$http","$state","$location","$window","Authentication"]}();
